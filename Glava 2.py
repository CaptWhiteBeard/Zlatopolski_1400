...
####################################################################################
# 2.22.	 Даны два числа. Найти среднее арифметическое и  
...
# средний возраст, а также определить, 
...
####################################################################################
# 2.34.	 Два автомобиля едут навстречу друг другу с 
# постоянными скоростями V1 и V2 км/ч. 
...
####################################################################################
# 2.35.	 Два автомобиля едут друг за другом с 
# постоянными скоростями V1 и V2 км/ч (V1 > V2).
...
####################################################################################
# 2.36.	 Известно значение температуры по шкале Цельсия.
# Найти соответствующее значение температуры по шкале:
# а) Фаренгейта;
# б) Кельвина.
# Для пересчета по шкале Фаренгейта необходимо исходное значение 
# температуры умножить на 1,8 и к результату прибавить
# 32, а по шкале Кельвина абсолютное значение нуля 
