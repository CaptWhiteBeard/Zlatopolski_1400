...
####################################################################################
# 3.43. Даны цифры двух двузначных чисел, записываемых в ви-
# де a2a1 и b2b1, где a1 и b1 – число единиц, a2 и b2 – число десятков.
# Получить цифры числа, равного сумме заданных чисел (известно,
# что это число двузначное). Слагаемое – двузначное число и чис-
# ло-результат не определять; условный оператор не использовать.
####################################################################################


####################################################################################
# 3.44. Даны цифры двух десятичных целых чисел: трехзначного
# a3a2a1 и двузначного b2b1, где a1 и b1 – число единиц, a2 и b2 – число
# десятков, a3 – число сотен. Получить цифры числа, равного сумме
# заданных чисел (известно, что это число трехзначное). Числа-сла-
# гаемые и число-результат не определять; условный оператор не
# использовать.
####################################################################################
